...
<head>
    ...
    <title>Teste Pull Up - Marcelo</title>
...
<body class="font-sans bg-gray-900 text-white">
        ...
        <div class="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between px-4 py-6">
            <ul class="flex flex-col md:flex-row items-center">
                ...
                <li class="md:ml-6 mt-3 md:mt-0">
                    <a href="{{ route('tv.index') }}" class="hover:text-gray-300">Series de Tv</a>
                </li>
                <li class="md:ml-6 mt-3 md:mt-0">
                    <a href="{{ route('atores.index') }}" class="hover:text-gray-300">Atores</a>
                </li>
            </ul>
    ...
    <footer class="border border-t border-gray-800">
        <div class="container mx-auto text-sm px-4 py-6">
            Api utilizada <a href="https://www.themoviedb.org/documentation/api" class="underline hover:text-gray-300">TMDb</a>
        </div>
    </footer>
    <livewire:scripts>
    @yield('scripts')
